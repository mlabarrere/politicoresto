-- Baseline schema (dump from staging 2026-04-21) — bootstrap pour Supabase Preview.
-- Ce fichier remplace le placeholder "select 1;" d'origine.
-- Idempotent : CREATE TABLE IF NOT EXISTS, CREATE OR REPLACE {VIEW,FUNCTION,TRIGGER},
-- CREATE EXTENSION IF NOT EXISTS. Sur staging/prod où cette version (20260402193642)
-- est déjà marquée appliquée, Supabase CLI ne re-run pas — pas d'effet.
-- Sur une DB fraîche (Supabase Preview de branche), crée le schéma de base
-- pour que les migrations 20260419+ (qui ajoutent subject, thread_post_subject,
-- media_outlet, election, etc.) puissent se chaîner sans erreur de FK.
...
CREATE OR REPLACE FUNCTION "private"."trigger_refresh_public_read_models"() RETURNS "trigger"
    LANGUAGE "plpgsql"
...
ALTER FUNCTION "private"."trigger_refresh_public_read_models"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."poll_bucket_for_user"("p_user_id" "uuid", "p_dimension_key" "text") RETURNS "text"
    LANGUAGE "sql" STABLE
    AS $$
  select case
...
ALTER FUNCTION "public"."poll_bucket_for_user"("p_user_id" "uuid", "p_dimension_key" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."post_poll_snapshot" (
    ...
    "effective_sample_size" numeric DEFAULT 0 NOT NULL,
    "distance_score" numeric DEFAULT 0 NOT NULL,
    "coverage_score" numeric DEFAULT 0 NOT NULL,
    "stability_score" numeric DEFAULT 0 NOT NULL,
    "anti_brigading_score" numeric DEFAULT 50 NOT NULL,
    "representativity_score" numeric DEFAULT 0 NOT NULL,
    "raw_results" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "corrected_results" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "computed_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL
);


ALTER TABLE "public"."post_poll_snapshot" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."recompute_post_poll_snapshot"("p_post_item_id" "uuid") RETURNS "public"."post_poll_snapshot"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."recompute_post_poll_snapshot"("p_post_item_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."refresh_public_read_models"() RETURNS "void"
    LANGUAGE "sql"
    AS $$ select; $$;


ALTER FUNCTION "public"."refresh_public_read_models"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."submit_post_poll_vote"("p_post_item_id" "uuid", "p_option_id" "uuid") RETURNS "public"."post_poll_snapshot"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."validate_poll_visibility"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "public"."validate_poll_visibility"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_topic_visibility"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "public"."validate_topic_visibility"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."post_poll_target_distribution" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "model_version" "text" DEFAULT 'fr_v1'::"text" NOT NULL,
    "dimension_key" "text" NOT NULL,
    "bucket_key" "text" NOT NULL,
    "target_share" numeric NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "post_poll_target_distribution_target_share_check" CHECK ((("target_share" >= (0)::numeric) AND ("target_share" <= (1)::numeric)))
);


ALTER TABLE "public"."post_poll_target_distribution" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."v_post_poll_summary" AS
 ...
 SELECT "pp"."post_item_id",
    ...
    COALESCE("ps"."effective_sample_size", (0)::numeric) AS "effective_sample_size",
    COALESCE("ps"."representativity_score", (0)::numeric) AS "representativity_score",
    COALESCE("ps"."coverage_score", (0)::numeric) AS "coverage_score",
    COALESCE("ps"."distance_score", (0)::numeric) AS "distance_score",
    COALESCE("ps"."stability_score", (0)::numeric) AS "stability_score",
    COALESCE("ps"."anti_brigading_score", (0)::numeric) AS "anti_brigading_score",
...
CREATE OR REPLACE VIEW "public"."v_public_profiles" AS
 SELECT "user_id",
    ...
    "created_at"
   FROM "public"."app_profile" "ap"
  WHERE (("profile_status" = 'active'::"public"."profile_status") AND ("is_public_profile_enabled" = true));


ALTER VIEW "public"."v_public_profiles" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."post_poll_snapshot"
    ADD CONSTRAINT "post_poll_snapshot_pkey" PRIMARY KEY ("post_item_id");



ALTER TABLE ONLY "public"."post_poll_target_distribution"
    ADD CONSTRAINT "post_poll_target_distribution_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."post_poll_target_distribution"
    ADD CONSTRAINT "post_poll_target_distribution_unique" UNIQUE ("model_version", "dimension_key", "bucket_key");
...
CREATE INDEX "post_poll_target_dim_idx" ON "public"."post_poll_target_distribution" USING "btree" ("model_version", "dimension_key") WHERE ("is_active" = true);
...
CREATE OR REPLACE TRIGGER "refresh_public_read_models_after_post_write" AFTER INSERT OR DELETE OR UPDATE ON "public"."post" FOR EACH STATEMENT EXECUTE FUNCTION "private"."trigger_refresh_public_read_models"();



CREATE OR REPLACE TRIGGER "refresh_public_read_models_after_topic_resolution_source_write" AFTER INSERT OR DELETE OR UPDATE ON "public"."topic_resolution_source" FOR EACH STATEMENT EXECUTE FUNCTION "private"."trigger_refresh_public_read_models"();



CREATE OR REPLACE TRIGGER "refresh_public_read_models_after_topic_resolution_write" AFTER INSERT OR DELETE OR UPDATE ON "public"."topic_resolution" FOR EACH STATEMENT EXECUTE FUNCTION "private"."trigger_refresh_public_read_models"();



CREATE OR REPLACE TRIGGER "refresh_public_read_models_after_topic_write" AFTER INSERT OR DELETE OR UPDATE ON "public"."topic" FOR EACH STATEMENT EXECUTE FUNCTION "private"."trigger_refresh_public_read_models"();
...
CREATE OR REPLACE TRIGGER "validate_topic_visibility_before_write" BEFORE INSERT OR UPDATE ON "public"."topic" FOR EACH ROW EXECUTE FUNCTION "public"."validate_topic_visibility"();
...
ALTER TABLE ONLY "public"."post_poll_snapshot"
    ADD CONSTRAINT "post_poll_snapshot_post_item_id_fkey" FOREIGN KEY ("post_item_id") REFERENCES "public"."post_poll"("post_item_id") ON DELETE CASCADE;
...
CREATE POLICY "post_poll_snapshot_admin_write" ON "public"."post_poll_snapshot" USING (("public"."is_admin"() OR "public"."is_moderator"())) WITH CHECK (("public"."is_admin"() OR "public"."is_moderator"()));



CREATE POLICY "post_poll_snapshot_read" ON "public"."post_poll_snapshot" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."post_poll" "pp"
  WHERE (("pp"."post_item_id" = "post_poll_snapshot"."post_item_id") AND "public"."can_read_post_poll"("pp".*)))));



CREATE POLICY "post_poll_target_admin_write" ON "public"."post_poll_target_distribution" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "post_poll_target_read" ON "public"."post_poll_target_distribution" FOR SELECT USING (("public"."is_admin"() OR "public"."is_moderator"()));
...
GRANT ALL ON FUNCTION "public"."poll_bucket_for_user"("p_user_id" "uuid", "p_dimension_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."poll_bucket_for_user"("p_user_id" "uuid", "p_dimension_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."poll_bucket_for_user"("p_user_id" "uuid", "p_dimension_key" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."post_poll_snapshot" TO "anon";
GRANT ALL ON TABLE "public"."post_poll_snapshot" TO "authenticated";
GRANT ALL ON TABLE "public"."post_poll_snapshot" TO "service_role";



REVOKE ALL ON FUNCTION "public"."recompute_post_poll_snapshot"("p_post_item_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."recompute_post_poll_snapshot"("p_post_item_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."recompute_post_poll_snapshot"("p_post_item_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_public_read_models"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_public_read_models"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_public_read_models"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_poll_visibility"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_topic_visibility"() TO "service_role";
...
GRANT ALL ON TABLE "public"."post_poll_target_distribution" TO "anon";
GRANT ALL ON TABLE "public"."post_poll_target_distribution" TO "authenticated";
GRANT ALL ON TABLE "public"."post_poll_target_distribution" TO "service_role";
...
GRANT ALL ON TABLE "public"."v_public_profiles" TO "anon";
GRANT ALL ON TABLE "public"."v_public_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."v_public_profiles" TO "service_role";
