...
| Preview / Staging  | `<SUPABASE_STAGING_PROJECT_REF>`                         | Preview    | auto (CI `migrate-staging.yml` sur `main`)  |
...
1. **Vercel Dashboard → Settings → Environment Variables**
   - `NEXT_PUBLIC_SUPABASE_URL` = `https://<SUPABASE_STAGING_PROJECT_REF>.supabase.co` — scope **Preview uniquement**
