...
describe('appDraftList', () => {
  ...
  it('shows unavailable state', () => {
    ...
    expect(
      screen.getByText('Brouillons indisponibles temporairement'),
    ).toBeTruthy();
  });
...
describe('appPostHistoryList', () => {
  ...
  it('shows unavailable state', () => {
    ...
    expect(
      screen.getByText('Publications indisponibles temporairement'),
    ).toBeTruthy();
  });
...
describe('appCommentHistoryList', () => {
  ...
  it('shows unavailable state', () => {
    ...
    expect(
      screen.getByText('Commentaires indisponibles temporairement'),
    ).toBeTruthy();
  });
