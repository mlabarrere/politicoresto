...
import { normalizeSourceUrl, extractUrlPreviewFromHtml, fetchUrlPreview } from "@/lib/utils/url-preview";
...
describe("extractUrlPreviewFromHtml", () => {
  ...
  it("returns undefined for missing fields", () => {
    const result = extractUrlPreviewFromHtml("<html></html>", "https://example.com");
