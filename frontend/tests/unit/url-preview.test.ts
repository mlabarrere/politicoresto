...
import { extractUrlPreviewFromHtml, normalizeSourceUrl } from "@/lib/utils/url-preview";
...
describe("url preview utilities", () => {
  ...
  it("normalizes valid url input and rejects invalid protocols", () => {
    ...
    expect(normalizeSourceUrl("https://example.com/test")).toBe("https://example.com/test");
