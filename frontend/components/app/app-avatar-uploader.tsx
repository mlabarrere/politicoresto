...
export function AppAvatarUploader({
  ...
  return (
    <AppCard className="space-y-3 p-3">
      <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Photo de profil</p>
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-muted-foreground">URL image (optionnelle)</p>
        </div>
      </div>
      <AppInput name="avatar_url" defaultValue={defaultValue ?? ""} placeholder="https://..." />
    </AppCard>
  );
}
