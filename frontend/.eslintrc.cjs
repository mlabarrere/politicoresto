...
module.exports = {
  ...
  overrides: [
    ...
    // Generated by `supabase gen types`. We do not own its style choices
    // (e.g. top-level `type Json = …`); regenerating it is the source of
    // truth, so silence the rules that fight the generator.
    {
      files: ['lib/types/supabase.ts'],
      rules: {
